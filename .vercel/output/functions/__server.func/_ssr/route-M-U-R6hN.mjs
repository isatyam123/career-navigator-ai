...
function AppSidebar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarFooter, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-col gap-2 group-data-[collapsible=icon]:hidden",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3 rounded-xl bg-sidebar-accent/50 p-2",
					children: [profile.avatar_url ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						className: "flex h-9 w-9 items-center justify-center rounded-full bg-gradient-brand text-xs font-semibold text-white",
			...
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							...
							className: "hidden rounded-xl bg-gradient-brand text-white shadow-glow hover:opacity-95 sm:inline-flex",
							children: "+ New Application"
						})]
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
				className: "flex-1 animate-fade-in p-4 md:p-8",
